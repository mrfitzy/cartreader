...
// GB Flash items
static const char GBFlashItem0[] PROGMEM = "SST 39SF010A Cart";
...
static const char* const menuOptionsGBFlash[] PROGMEM = { GBFlashItem0, GBFlashItem1, GBFlashItem2, GBFlashItem3, GBFlashItem4, GBFlashItem5, GBFlashItem6, FSTRING_RESET };
